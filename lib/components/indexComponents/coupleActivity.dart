...
class CoupleActivity extends StatefulWidget{

  CoupleActivity();

  @override
  _CoupleActivity createState() => _CoupleActivity();
}

class _CoupleActivity extends State<CoupleActivity> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: (){
          Navigator.of(context).pushNamed("views/addTopic", arguments: Argument(2)).then((data){
            getData();
          });
        },
      ),
